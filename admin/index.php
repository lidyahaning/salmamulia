...
<body>
	...
	<center>
		<img src="../gambar/logo.png" class="img-rounded">
		<!--br><br>
		<button type='button' class='btn btn-default btn-lg'><a href='dasar.php?page=tambah_galeri'><h4>TAMBAH GALERI</h4></a></button-->
	</center>
